...
scp build/f1telemetry "root@$DEVICE:$APPDIR/.f1telemetry.new"
ssh "root@$DEVICE" "mv -f $APPDIR/.f1telemetry.new $APPDIR/f1telemetry && chmod +x $APPDIR/f1telemetry"
